    ...
    (function () {
      ...
      function L(t, e, n, r) {
        if ((!r || n) && ("object" != typeof n || null === n))
          throw new Error(F(t, e, r) + "must be a valid context object.");
      }
      function M(t) {
      ...
      function tt() {
        ...
        if (
          (!0 === yt &&
            ((yt = !1),
            null === _t && !0 === ct.get("logging_enabled") && Z(!0)),
          _t)
        ) {
      ...
      function at(t, e) {
        ...
        throw new Error("Missing required key (" + t + ") in object: " + T(e));
      }
      function ht(t, e) {
        var n = t.length;
        if (n <= e) return [t];
      ...
      function bt(t) {
        try {
          ...
          setTimeout(function () {
            var t = e.stack || "";
            throw (it("Exception was thrown by user callback.", t), e);
          }, Math.floor(0));
        }
      }
      function St(t, e) {
      ...
      var Tt = new RegExp("^-?(0*)\\d{1,10}$"),
        ...
        Nt =
          ...
          (Rt.prototype.popFront = function () {
            ...
            return t < this.pieces_.length && t++, new Rt(this.pieces_, t);
          }),
          ...
          (Rt.relativePath = function (t, e) {
            var n = t.getFront(),
              r = e.getFront();
            if (null === n) return e;
            if (n === r) return Rt.relativePath(t.popFront(), e.popFront());
            throw new Error(
      ...
      var Ot = "firebaseio.com",
        ...
        Ft =
          ...
          (At.prototype.connectionURL = function (t, e) {
            var n;
            if (
              (C("string" == typeof t, "typeof type must == string"),
              ...
              if (t !== kt) throw new Error("Unknown connection type: " + t);
              n =
      ...
      function Lt(t) {
        ...
        return {
          repoInfo: new Ft(e.host, e.secure, n, r, "", n !== e.subdomain),
      ...
      function Ut(t, e, n, r, i) {
        if (!i || void 0 !== n) {
          ...
          Et(n, function (t, e) {
            var n = new Nt(t);
            if ((Jt(o, e, r.child(n)), ".priority" === n.getBack() && !Qt(e)))
              throw new Error(
                o +
      ...
      function Yt(t, e, n) {
        ...
        if (
          ...
          (0 !== r.length &&
            !(function (t) {
              return (t = t && t.replace(/^\/*\.info(\/|$)/, "/")), Wt(t);
            })(r))
        )
          throw new Error(
            F(t, e, !1) +
        ...
        Jt = function (n, t, e) {
          ...
          if (t && "object" == typeof t) {
            ...
            if (
              (Et(t, function (t, e) {
                if (".value" === t) i = !0;
                else if (".priority" !== t && ".sv" !== t && ((o = !0), !Mt(t)))
                  throw new Error(
                    n +
                      " contains an invalid key (" +
                      t +
        ...
        se =
          ...
          function (t) {
            ...
            if (n) {
              ...
              for (e = 0; e < 12; e++) oe[e] = Math.floor(64 * Math.random());
      ...
      function ge(t) {
        ...
        } else C(t === _e || t.isEmpty(), "priority of unexpected type.");
        C(
      ...
      var me,
        ...
        be =
          ...
          (Se.prototype.hash = function () {
            if (null === this.lazyHash_) {
              ...
              this.priorityNode_.isEmpty() ||
                (t += "priority:" + ve(this.priorityNode_.val()) + ":");
              var e = typeof this.value_;
              (t += e + ":"),
                (t += "number" == e ? wt(this.value_) : this.value_),
                (this.lazyHash_ = J(t));
            }
          ...
          (Se.VALUE_TYPE_ORDER = ["object", "boolean", "number", "string"]),
          Se);
      function Se(t, e) {
          ...
          var c = function (t, e) {
            ...
            n = (function (t) {
              for (
                ...
                o ? r(s, Pe.BLACK) : (r(s, Pe.BLACK), r(s, Pe.RED));
              }
              return n;
            })(new Le(l.length));
          return new ke(e || t, n);
          ...
          (Object.defineProperty(He, "Default", {
            get: function () {
              return (
                ...
                (We = We || new He({ ".priority": Ue }, { ".priority": Ie }))
              );
            },
            enumerable: !0,
            configurable: !0,
          ...
          (He.prototype.addToIndexes = function (h, l) {
            ...
            return new He(
              D(this.indexes_, function (t, e) {
                ...
                if ((C(n, "Missing index implementation for " + e), t === Ue)) {
                  if (n.isDefinedOn(h.node)) {
                    for (
                      var r = [], i = l.getIterator(ae.Wrap), o = i.getNext();
                      o;

                    )
                      o.name !== h.name && r.push(o), (o = i.getNext());
                ...
                var s = l.get(h.name),
                  a = t;
                return (
                  s && (a = a.remove(new ae(h.name, s))), a.insert(h, h.node)
                );
              }),
              this.indexSet_
            );
      ...
      var Ke,
        Ye =
          (Object.defineProperty(ze, "EMPTY_NODE", {
            get: function () {
              return (Qe = Qe || new ze(new ke(je), null, Ve.Default));
            },
            enumerable: !0,
            configurable: !0,
          }),
          ...
          (ze.prototype.hash = function () {
            if (null === this.lazyHash_) {
              var r = "";
              this.getPriority().isEmpty() ||
                (r += "priority:" + ve(this.getPriority().val()) + ":"),
                this.forEachChild(Ie, function (t, e) {
                  var n = e.hash();
                  "" !== n && (r += ":" + t + ":" + n);
                }),
          ...
          (ze.prototype.getIteratorFrom = function (t, e) {
            ...
            for (
              var r = this.children_.getIteratorFrom(t.name, ae.Wrap),
                i = r.peek();
          ...
          (ze.prototype.getReverseIteratorFrom = function (t, e) {
            ...
            for (
              var r = this.children_.getReverseIteratorFrom(t.name, ae.Wrap),
                i = r.peek();
          ...
          (ze.prototype.resolveIndex_ = function (t) {
            return t === ye ? null : this.indexMap_.get(t.toString());
          }),
      ...
      function Ge() {
        return Ke.call(this, new ke(je), Ye.EMPTY_NODE, Ve.Default) || this;
      }
      ...
      var $e,
        Je = !0;
      function Ze(r, t) {
        if ((void 0 === t && (t = null), null === r)) return Ye.EMPTY_NODE;
        if (
        ...
        if (
          (Et(r, function (t, e) {
            if ("." !== t.substring(0, 1)) {
              var n = Ze(e);
              n.isEmpty() ||
                ((s = s || !n.getPriority().isEmpty()), o.push(new ae(t, n)));
            }
          }),
          0 === o.length)
        )
      ...
      var sn =
        ((an.prototype.val = function () {
          return (
            k("DataSnapshot.val", 0, 0, arguments.length), this.node_.val()
          );
        }),
        ...
        (an.prototype.toJSON = function () {
          return (
            k("DataSnapshot.toJSON", 0, 1, arguments.length), this.exportVal()
          );
        }),
      ...
      var pn =
        ...
        (dn.prototype.createEvent = function (t, e) {
          ...
          return new hn("value", this, new sn(t.snapshotNode, e.getRef(), n));
        }),
              ...
              if (this.context_ === e.context_) {
                ...
                if (i === r.length) {
                  ...
                  return !(
                    ...
                    (e.callbacks_[o] &&
                      this.callbacks_[s] &&
                      e.callbacks_[o] !== this.callbacks_[s])
                  );
                }
              }
            }
      ...
      var vn =
        ...
        (gn.prototype.off = function (t, e, n) {
          ...
          "value" === t
            ...
            : t && (e && ((i = {})[t] = e), (r = new _n(i, null, n || null))),
        ...
        (gn.prototype.orderByChild = function (t) {
          if ((k("Query.orderByChild", 1, 1, arguments.length), "$key" === t))
            throw new Error(
          ...
          return (
            gn.validateQueryEndpoints_(r), new gn(this.repo, this.path, r, !0)
          );
        }),
        (gn.prototype.orderByKey = function () {
          ...
          return (
            gn.validateQueryEndpoints_(t), new gn(this.repo, this.path, t, !0)
          );
        }),
        ...
        (gn.prototype.isEqual = function (t) {
          if ((k("Query.isEqual", 1, 1, arguments.length), !(t instanceof gn)))
            throw new Error(
        ...
        Rn =
          ((Pn.prototype.operationForChild = function (t) {
            ...
            return (
              ...
              new Pn(this.path.popFront(), this.affectedTree, this.revert)
            );
          }),
          Pn);
      function Pn(t, e, n) {
      ...
      var Dn =
        ...
        (On.prototype.findRootMostMatchingPathAndValue = function (t, e) {
        ...
        (On.prototype.set = function (t, e) {
          ...
          var n = t.getFront(),
            r = (this.children.get(n) || On.Empty).set(t.popFront(), e),
        ...
        (On.prototype.setTree = function (t, e) {
          ...
          var n = t.getFront(),
            r = (this.children.get(n) || On.Empty).setTree(t.popFront(), e),
            i = void 0;
          return (
            (i = r.isEmpty()
        ...
        (On.prototype.foreachOnPath_ = function (t, e, n) {
          ...
          return i ? i.foreachOnPath_(t.popFront(), e.child(r), n) : On.Empty;
        }),
      ...
      var xn =
        ...
        kn);
      function kn(t, e) {
        (this.source = t), (this.path = e), (this.type = wn.LISTEN_COMPLETE);
      }
      var Fn =
        ((An.prototype.operationForChild = function (t) {
          return this.path.isEmpty()
            ? new An(this.source, Nt.Empty, this.snap.getImmediateChild(t))
        ...
        ((jn.prototype.updateChild = function (t, e, n, r, i, o) {
          ...
          return s.getChild(r).equals(n.getChild(r)) &&
            ...
            : (null != o &&
                (n.isEmpty()
                  ? t.hasChild(e)
                    ? o.trackChildChange(Vn.childRemovedChange(e, s))
                    : C(
                        t.isLeafNode(),
                        "A child remove without an old child only makes sense on a leaf node"
                      )
                  : s.isEmpty()
                  ? o.trackChildChange(Vn.childAddedChange(e, n))
                  : o.trackChildChange(Vn.childChangedChange(e, n, s))),
            ...
            null != i &&
              (r.isLeafNode() ||
                r.forEachChild(Ie, function (t, e) {
                  n.hasChild(t) ||
                    i.trackChildChange(Vn.childRemovedChange(t, e));
                }),
              n.isLeafNode() ||
                n.forEachChild(Ie, function (t, e) {
                  if (r.hasChild(t)) {
                    ...
                    n.equals(e) ||
                      i.trackChildChange(Vn.childChangedChange(t, e, n));
        ...
        ((Yn.prototype.trackChildChange = function (t) {
          ...
          if (r) {
            ...
            if (e === Vn.CHILD_ADDED && i === Vn.CHILD_REMOVED)
              this.changeMap.set(
                n,
                Vn.childChangedChange(n, t.snapshotNode, r.snapshotNode)
              );
            else if (e === Vn.CHILD_REMOVED && i === Vn.CHILD_ADDED)
              this.changeMap.delete(n);
            else if (e === Vn.CHILD_REMOVED && i === Vn.CHILD_CHANGED)
              this.changeMap.set(n, Vn.childRemovedChange(n, r.oldSnap));
            else if (e === Vn.CHILD_CHANGED && i === Vn.CHILD_ADDED)
              this.changeMap.set(n, Vn.childAddedChange(n, t.snapshotNode));
            else {
              if (e !== Vn.CHILD_CHANGED || i !== Vn.CHILD_CHANGED)
                throw c(
              ...
              this.changeMap.set(
                n,
                Vn.childChangedChange(n, t.snapshotNode, r.oldSnap)
              );
            }
      ...
      var Jn = function (t, e) {
        ...
        Zn =
            ...
            if (e.type === wn.OVERWRITE) {
              ...
              i = a.source.fromUser
                ...
                : (C(a.source.fromServer, "Unknown source."),
                  (o =
                    a.source.tagged ||
                    (t.getServerCache().isFiltered() && !a.path.isEmpty())),
              ...
              i = l.revert
                ...
                : this.ackUserWrite_(t, l.path, l.affectedTree, n, r, s);
            } else {
            ...
            if (e.isEmpty())
              ...
              if (".priority" === p) {
                ...
                if (o.isCompleteForChild(p)) {
                  ...
                  y =
                    null != v
                      ? o.getNode().getImmediateChild(p).updateChild(_, v)
                      : o.getNode().getImmediateChild(p);
                } else y = n.calcCompleteChild(p, t.getServerCache());
                s =
                  null != y
                    ? this.filter_.updateChild(o.getNode(), p, y, _, r, i)
                    : o.getNode();
              }
            }
          ...
          (tr.prototype.applyServerOverwrite_ = function (t, e, n, r, i, o, s) {
            var a,
              h = t.getServerCache(),
            ...
            if (e.isEmpty()) a = l.updateFullNode(h.getNode(), n, null);
              ...
              a =
                ".priority" === c
                  ...
                  : l.updateChild(h.getNode(), c, d, p, Gn, null);
            }
          ...
          (tr.prototype.applyUserOverwrite_ = function (t, e, n, r, i, o) {
            var s,
              a,
              h = t.getEventCache(),
              l = new Xn(r, t, i);
          ...
          (tr.prototype.applyUserMerge_ = function (r, i, t, o, s, a) {
            var h = this,
              l = r;
            return (
              t.foreach(function (t, e) {
                ...
                tr.cacheHasChild_(r, n.getFront()) &&
                  (l = h.applyUserOverwrite_(l, n, e, o, s, a));
              }),
              t.foreach(function (t, e) {
                var n = i.child(t);
                tr.cacheHasChild_(r, n.getFront()) ||
          ...
          (tr.prototype.applyServerMerge_ = function (o, t, e, s, a, h, l) {
            var u = this;
            if (
              ...
              n.children.inorderTraversal(function (t, e) {
                if (p.hasChild(t)) {
                  var n = o.getServerCache().getNode().getImmediateChild(t),
                    r = u.applyMerge_(n, e);
                  c = u.applyServerOverwrite_(c, new Nt(t), r, s, a, h, l);
                }
              }),
              n.children.inorderTraversal(function (t, e) {
                var n =
                  !o.getServerCache().isCompleteForChild(t) && null == e.value;
                if (!p.hasChild(t) && !n) {
                  var r = o.getServerCache().getNode().getImmediateChild(t),
                    i = u.applyMerge_(r, e);
                  c = u.applyServerOverwrite_(c, new Nt(t), i, s, a, h, l);
                }
              }),
              c
            );
          ...
          (tr.prototype.ackUserWrite_ = function (t, r, e, n, i, o) {
            ...
            if (null != e.value) {
              ...
              if (r.isEmpty()) {
                var h = Dn.Empty;
                return (
                  a.getNode().forEachChild(ye, function (t, e) {
                    h = h.set(new Nt(t), e);
                  }),
          ...
          (tr.prototype.listenComplete_ = function (t, e, n, r) {
            ...
            return this.generateEventCacheAfterServerEvent_(o, e, n, Gn, r);
          }),
          (tr.prototype.revertUserWrite_ = function (t, e, n, r, i) {
            ...
            if (e.isEmpty() || ".priority" === e.getFront()) {
              ...
              null == p &&
                ...
                (h =
                  null != p
                    ? this.filter_.updateChild(a, c, p, e.popFront(), s, i)
                    : t.getEventCache().getNode().hasChild(c)
          ...
          return (
            t.forEach(function (t) {
              t.type === Vn.CHILD_CHANGED &&
                ...
                o.push(Vn.childMovedChange(t.childName, t.snapshotNode));
            }),
            this.generateEventsForType_(i, Vn.CHILD_REMOVED, t, n, e),
            this.generateEventsForType_(i, Vn.CHILD_ADDED, t, n, e),
            this.generateEventsForType_(i, Vn.CHILD_MOVED, o, n, e),
            this.generateEventsForType_(i, Vn.CHILD_CHANGED, t, n, e),
            this.generateEventsForType_(i, Vn.VALUE, t, n, e),
            i
          );
        }),
        (nr.prototype.generateEventsForType_ = function (r, e, t, i, o) {
          var s = this,
        ...
        ir =
          ...
          (or.prototype.getInitialEvents = function (t) {
            ...
            return (
              ...
              e.isFullyInitialized() && n.push(Vn.valueChange(e.getNode())),
              this.generateEventsForChanges_(n, e.getNode(), t)
            );
          }),
          (or.prototype.generateEventsForChanges_ = function (t, e, n) {
      ...
      var sr =
        (Object.defineProperty(ar, "__referenceConstructor", {
          ...
          set: function (t) {
            C(!rr, "__referenceConstructor has already been defined"), (rr = t);
          },
          enumerable: !0,
          configurable: !0,
        }),
        ...
        (ar.prototype.applyOperation = function (t, e, n) {
          ...
          if (null !== o) {
            ...
            return (
              C(null != s, "SyncTree gave us an op for an invalid query."),
        ...
        (ar.prototype.removeEventRegistration = function (t, e, n) {
          ...
          return (
            h &&
              ...
              s.push(new ar.__referenceConstructor(t.repo, t.path)),
            { removed: s, events: a }
          );
        }),
      ...
      var hr =
        ((lr.prototype.addWrite = function (t, e) {
          ...
          if (null != n) {
            ...
            return (i = i.updateChild(o, e)), new lr(this.writeTree_.set(r, i));
          }
          var s = new Dn(e);
        ...
        (lr.prototype.getCompleteNode = function (t) {
          ...
          return null != e
            ? this.writeTree_.get(e.path).getChild(Nt.relativePath(e.path, t))
            : null;
        }),
          ...
          return (
            null != t
              ...
              : this.writeTree_.children.inorderTraversal(function (t, e) {
                  null != e.value && n.push(new ae(t, e.value));
                }),
            n
          );
        }),
        (lr.prototype.childCompoundWrite = function (t) {
          ...
          return new lr(null != e ? new Dn(e) : this.writeTree_.subtree(t));
        }),
        ...
        (cr.layerTree_ = function (t, e, n) {
          for (var r = hr.Empty, i = 0; i < t.length; ++i) {
            ...
            if (e(o)) {
              ...
              if (o.snap)
                n.contains(s)
                  ? ((a = Nt.relativePath(n, s)), (r = r.addWrite(a, o.snap)))
                  : s.contains(n) &&
                    ((a = Nt.relativePath(s, n)),
                    (r = r.addWrite(Nt.Empty, o.snap.getChild(a))));
              else {
                if (!o.children)
                  throw c("WriteRecord should have .snap or .children");
                if (n.contains(s))
                  (a = Nt.relativePath(n, s)), (r = r.addWrites(a, o.children));
      ...
      var pr =
        ...
        (dr.prototype.calcEventCacheAfterServerOverwrite = function (t, e, n) {
      ...
      var fr =
        ((_r.prototype.applyUserOverwrite = function (t, e, n, r) {
          return (
            ...
            r ? this.applyOperationToSyncPoints_(new Fn(Tn.User, t, e)) : []
          );
        }),
        (_r.prototype.applyUserMerge = function (t, e, n) {
          this.pendingWriteTree_.addMerge(t, e, n);
          var r = Dn.fromObject(e);
          return this.applyOperationToSyncPoints_(new Ln(Tn.User, t, r));
        }),
        (_r.prototype.ackUserWrite = function (t, e) {
          ...
          if (this.pendingWriteTree_.removeWrite(t)) {
            ...
            return (
              ...
              this.applyOperationToSyncPoints_(new Rn(n.path, r, e))
            );
          }
          return [];
        }),
        (_r.prototype.applyServerOverwrite = function (t, e) {
          return this.applyOperationToSyncPoints_(new Fn(Tn.Server, t, e));
        }),
        (_r.prototype.applyServerMerge = function (t, e) {
          var n = Dn.fromObject(e);
          return this.applyOperationToSyncPoints_(new Ln(Tn.Server, t, n));
        }),
        (_r.prototype.applyListenComplete = function (t) {
          return this.applyOperationToSyncPoints_(new xn(Tn.Server, t));
        }),
        ...
        (_r.prototype.removeEventRegistration = function (t, e, n) {
          ...
          if (
            ...
            if (l && !u) {
              ...
              if (!c.isEmpty())
                for (
                  var p = this.collectDistinctViewsForSubTree_(c), d = 0;
                  d < p.length;
                  ++d
                ) {
                  var f = p[d],
            ...
            !u &&
              ...
              (l
                ...
                : h.forEach(function (t) {
                    var e = r.queryToTagMap.get(_r.makeQueryKey_(t));
        ...
        (_r.parseQueryKey_ = function (t) {
          ...
          return (
            ...
            { queryId: t.substr(e + 1), path: new Nt(t.substr(0, e)) }
          );
        }),
        ...
        (_r.prototype.applyOperationHelper_ = function (t, e, n, r) {
          ...
          null == n && null != i && (n = i.getCompleteServerCache(Nt.Empty));
          var o = [],
            s = t.path.getFront(),
        ...
        (_r.prototype.applyOperationDescendantsHelper_ = function (o, t, s, a) {
          var h = this,
            e = t.get(Nt.Empty);
          null == s && null != e && (s = e.getCompleteServerCache(Nt.Empty));
          var l = [];
          return (
            t.children.inorderTraversal(function (t, e) {
              ...
              i &&
                (l = l.concat(h.applyOperationDescendantsHelper_(i, e, n, r)));
            }),
      ...
      var wr =
        ((br.getCollection = function (t) {
          var e = t.toString();
          return (
            this.collections_[e] || (this.collections_[e] = new Cr()),
            this.collections_[e]
          );
        }),
      ...
      var Ir =
        ...
        (Nr.prototype.reportStats_ = function () {
          var n = this,
            ...
            i = !1;
          Et(t, function (t, e) {
            0 < e && N(n.statsToReport_, t) && ((r[t] = e), (i = !0));
          }),
      ...
      var Rr =
        ...
        (Pr.prototype.raiseQueuedEventsMatchingPredicate_ = function (t) {
      ...
      var xr =
        ((kr.prototype.trigger = function (t) {
          ...
          if (Array.isArray(this.listeners_[t]))
            for (var r = o(this.listeners_[t]), i = 0; i < r.length; i++)
      ...
      var Fr,
        Ar =
          ...
          (Lr.prototype.getInitialEvent = function (t) {
            return (
              C("visible" === t, "Unknown event type: " + t), [this.visible_]
            );
          }),
          Lr);
      function Lr() {
      ...
      var Mr,
        Wr =
          ...
          (Qr.prototype.getInitialEvent = function (t) {
            return (
              C("online" === t, "Unknown event type: " + t), [this.online_]
            );
          }),
                ...
                s.scriptTagHolder = new Br(
                  ...
                  function () {
                    ...
                    var n = _(t, 2),
                      ...
                      i = n[1];
                    s.incrementIncomingBytes_(t),
                      s.myPacketOrderer.handleResponse(r, i);
                  },
                  function () {
                    s.onClosed_();
                  },
      ...
      var zr =
            ...
            if (y()) {
              var r = h.NODE_ADMIN ? "AdminNode" : "Node",
                i = {
                  headers: {
                    "User-Agent":
                      "Firebase/5/" + Kr + "/" + process.platform + "/" + r,
                  },
                },
                o = process.env,
                s =
        ...
        (Gr.previouslyFailed = function () {
          return (
            ut.isInMemoryStorage || !0 === ut.get("previous_websocket_failure")
          );
        }),
        ...
        (Gr.prototype.extractFrameCount_ = function (t) {
          if (
            (C(null === this.frames, "We already have a frame buffer"),
            t.length <= 6)
          ) {
            var e = Number(t);
        ...
        (Zr.prototype.onHandshake_ = function (t) {
          ...
          (this.sessionId = t.s),
            ...
            0 === this.state_ &&
              ...
              "5" !== n && it("Protocol version mismatch detected"),
      ...
      var ni,
        ri =
          ...
          (ii.prototype.reduceReconnectDelayIfAdminCredential_ = function (t) {
            ((t && 40 === t.length) ||
              (function (t) {
                var e = I(t).claims;
      ...
      var hi = "repo_interrupt",
        li =
          ...
          (ui.prototype.serverTime = function () {
            var t =
              this.infoData_.getNode(new Nt(".info/serverTimeOffset")).val() ||
              0;
          ...
          (ui.prototype.generateServerValues = function () {
            return (function (t) {
              return (
                ((t = t || {}).timestamp = t.timestamp || new Date().getTime()),
                t
              );
          ...
          (ui.prototype.setWithPriority = function (i, t, e, o) {
            ...
            var n = this.generateServerValues(),
              ...
              l = this.serverSyncTree_.applyUserOverwrite(i, a, h, !0);
            ...
            if (
              ...
              this.eventQueue_.queueEvents(e),
                this.server_.merge(o.toString(), t, function (t, e) {
                  ...
                  var r = a.serverSyncTree_.ackUserWrite(l, !n),
          ...
          (ui.prototype.runOnDisconnectEvents_ = function () {
            ...
            e.forEachTree(Nt.Empty, function (t, e) {
              i = i.concat(r.serverSyncTree_.applyServerOverwrite(t, e));
              var n = r.abortTransactions_(t);
              r.rerunTransactions_(n);
            }),
              (this.onDisconnect_ = new mn()),
              this.eventQueue_.raiseEventsForChangedPath(Nt.Empty, i);
          }),
          ...
          (ui.prototype.onDisconnectSetWithPriority = function (n, t, e, r) {
            var i = this,
              o = Ze(t, e);
            this.server_.onDisconnectPut(
              n.toString(),
          ...
          (ui.prototype.removeEventCallbackForQuery = function (t, e) {
            var n;
            (n =
              ".info" === t.path.getFront()
          ...
          (ui.prototype.resume = function () {
            this.persistentConnection_ && this.persistentConnection_.resume(hi);
          }),
          (ui.prototype.stats = function (t) {
            if ((void 0 === t && (t = !1), "undefined" != typeof console)) {
              ...
              e = t
                ? (this.statsListener_ ||
                    (this.statsListener_ = new Sr(this.stats_)),
          ...
          Object.defineProperty(ui.prototype, "database", {
            get: function () {
              return this.__database || (this.__database = new Pi(this));
            },
            enumerable: !0,
            configurable: !0,
          }),
      ...
      function ui(t, e, n, r) {
        ...
        i.addTokenChangeListener(function (t) {
          ...
          (this.statsReporter_ = wr.getOrCreateReporter(t, function () {
      ...
      var di =
        ((fi.prototype.updateChild = function (t, e, n, r, i, o) {
          return (
            this.rangedFilter_.matches(new ae(e, n)) || (n = Ye.EMPTY_NODE),
        ...
        (fi.prototype.updateFullNode = function (t, e, n) {
          ...
          if (e.isLeafNode() || e.isEmpty())
            ...
            r = (r = e.withIndex(this.index_)).updatePriority(Ye.EMPTY_NODE);
            var a = void 0,
              h = void 0,
              l = void 0;
            ...
            for (var c = !1; i.hasNext(); )
              (s = i.getNext()),
                ...
                c && o < this.limit_ && l(s, h) <= 0
                  ? o++
                  : (r = r.updateImmediateChild(s.name, Ye.EMPTY_NODE));
          }
        ...
        (fi.prototype.fullLimitUpdateChild_ = function (t, e, n, r, i) {
          ...
          if (a.hasChild(e)) {
            ...
            if (u && !n.isEmpty() && 0 <= d)
              return (
                null != i && i.trackChildChange(Vn.childChangedChange(e, n, c)),
                a.updateImmediateChild(e, n)
              );
            null != i && i.trackChildChange(Vn.childRemovedChange(e, c));
            var f = a.updateImmediateChild(e, Ye.EMPTY_NODE);
            return null != p && this.rangedFilter_.matches(p)
              ? (null != i &&
                  i.trackChildChange(Vn.childAddedChange(p.name, p.node)),
          ...
          return n.isEmpty()
            ...
            : u && 0 <= o(l, h)
            ? (null != i &&
                (i.trackChildChange(Vn.childRemovedChange(l.name, l.node)),
      ...
      var _i =
        ...
        (yi.prototype.isViewFromLeft = function () {
          return "" === this.viewFrom_
            ? this.startSet_
            : this.viewFrom_ === yi.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT;
        }),
        ...
        (yi.prototype.getLimit = function () {
          return (
            C(this.limitSet_, "Only valid if limit has been set"), this.limit_
          );
        }),
        ...
        (yi.prototype.limitToFirst = function (t) {
          ...
          return (
            (e.limitSet_ = !0),
            (e.limit_ = t),
            (e.viewFrom_ = yi.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT),
            e
          );
        }),
        (yi.prototype.limitToLast = function (t) {
          ...
          return (
            (e.limitSet_ = !0),
            (e.limit_ = t),
            (e.viewFrom_ = yi.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_RIGHT),
            e
          );
        }),
        ...
        (yi.prototype.getQueryObject = function () {
          ...
          return this.index_ !== Ie && (e[t.INDEX] = this.index_.toString()), e;
        }),
            ...
            this.isDefault() ||
              ((t =
                this.index_ === Ie
                  ...
                  : this.index_ === ye
                  ? e.KEY_INDEX
                  : (C(this.index_ instanceof rn, "Unrecognized index type!"),
                    this.index_.toString())),
              (n[e.ORDER_BY] = T(t)),
              this.startSet_ &&
                ((n[e.START_AT] = T(this.indexStartValue_)),
                this.startNameSet_ &&
                  (n[e.START_AT] += "," + T(this.indexStartName_))),
              this.endSet_ &&
                ((n[e.END_AT] = T(this.indexEndValue_)),
                this.endNameSet_ &&
                  (n[e.END_AT] += "," + T(this.indexEndName_))),
              this.limitSet_ &&
                (this.isViewFromLeft()
      ...
      var vi,
        gi =
          ...
          (mi.prototype.setWithPriority = function (t, e, n) {
            if (
              (k("Reference.setWithPriority", 2, 3, arguments.length),
            ...
            if (
              ...
              (function (t, e, n, r) {
                if ((!r || void 0 !== n) && "boolean" != typeof n)
                  throw new Error(F(t, e, r) + "must be a boolean.");
        ...
        bi =
          ((Si.prototype.subTree = function (t) {
            for (
              ...
              (n = new Si(r, n, R(n.node_.children, r) || new wi())),
          ...
          (Si.prototype.forEachImmediateDescendantWithValue = function (e) {
            this.forEachChild(function (t) {
              null !== t.getValue()
                ? e(t)
      ...
      ((Ei = Ci = Ci || {})[(Ei.RUN = 0)] = "RUN"),
        ...
        (li.prototype.startTransaction = function (t, e, n, r) {
          ...
          if (void 0 === h) {
            if (
              ...
              var l = new sn(s.currentInputSnapshot, new gi(this, s.path), Ie);
            ...
            var p = void 0;
            if ("object" == typeof h && null !== h && N(h, ".priority"))
              (p = R(h, ".priority")),
                C(
                  Qt(p),
              ...
              p = (
                this.serverSyncTree_.calcCompleteEventCache(t) || Ye.EMPTY_NODE
              )
                .getPriority()
                .val();
            p = p;
        ...
        (li.prototype.getLatestState_ = function (t, e) {
          return (
            this.serverSyncTree_.calcCompleteEventCache(t, e) || Ye.EMPTY_NODE
          );
        }),
              ...
              if ("ok" === t) {
                for (var n = [], r = 0; r < h.length; r++) {
                  if (
                    ...
                    (e = e.concat(
                      l.serverSyncTree_.ackUserWrite(h[r].currentWriteId)
                    )),
                    h[r].onComplete)
                  ) {
                ...
                l.pruneCompletedTransactionsBelowNode_(
                  ...
                  l.eventQueue_.raiseEventsForChangedPath(a, e);
                ...
                if ("datastale" === t)
                  ...
                  it("transaction at " + c.toString() + " failed: " + t);
                  for (r = 0; r < h.length; r++)
                    (h[r].status = Ci.NEEDS_ABORT), (h[r].abortReason = t);
                }
            ...
            for (
              ...
              if (
                ...
                if (a.retryCount >= li.MAX_TRANSACTION_RETRIES_)
                  ...
                  if (void 0 !== p) {
                    Jt("transaction failed: Data returned ", p, a.path);
                    var d = Ze(p);
                    ("object" == typeof p && null != p && N(p, ".priority")) ||
                      (d = d.updatePriority(c.getPriority()));
                    ...
                    (a.currentOutputSnapshotRaw = d),
                      ...
                      )).concat(this.serverSyncTree_.ackUserWrite(f, !0)));
                  } else
                    (l = !0),
                      (u = "nodata"),
                      (i = i.concat(
              ...
              if (
                ...
                if ("nodata" === u) {
                  ...
                  r.push(t[s].onComplete.bind(null, new Error(u), !1, null));
            }
        ...
        (li.prototype.aggregateTransactionQueuesForNode_ = function (t, e) {
          var n = this,
            r = t.getValue();
        ...
        (li.prototype.pruneCompletedTransactionsBelowNode_ = function (t) {
          var e = this,
            n = t.getValue();
          if (n) {
          ...
          return (function (o, s, a, h) {
            ...
            return e(this, function (t) {
              return (
                ...
                Ni.getInstance().deleteRepo(this.database.repo_),
